...
alt.onClient('TOP0', (player) => {
    ...
    verbindung.connection.query(`SELECT * FROM playerclohtes WHERE name = '${player.name}'`, function (err, result) {
        if (err) throw err;
        if (result.length > 0) {
              verbindung.connection.query(`UPDATE playerclohtes SET top_style = '${value}' WHERE name = '${player.name}'`, function (err, result) {
                if (err) throw err;
            });
        } else {
                verbindung.connection.query(`INSERT INTO playerclohtes (name, top_style) VALUES ('${player.name}', '${value}')`, function (err, result) {
                if (err) throw err;
            });
        }
    }
...
alt.onClient('HOSE1', (player) => {
    ...
    verbindung.connection.query(`SELECT * FROM playerclohtes WHERE name = '${player.name}'`, function (err, result) {
        if (err) throw err;
        if (result.length > 0) {
              verbindung.connection.query(`UPDATE playerclohtes SET legs_style = '${value}' WHERE name = '${player.name}'`, function (err, result) {
                if (err) throw err;
            });
        } else {
                verbindung.connection.query(`INSERT INTO playerclohtes (name, legs_style) VALUES ('${player.name}', '${value}')`, function (err, result) {
                if (err) throw err;
            });
        }
    }
...
alt.onClient('ARME1', (player) => {
    ...
    verbindung.connection.query(`SELECT * FROM playerclohtes WHERE name = '${player.name}'`, function (err, result) {
        if (err) throw err;
        if (result.length > 0) {
              verbindung.connection.query(`UPDATE playerclohtes SET torso_style = '${value}' WHERE name = '${player.name}'`, function (err, result) {
                if (err) throw err;
            });
        } else {
                verbindung.connection.query(`INSERT INTO playerclohtes (name, torso_style) VALUES ('${player.name}', '${value}')`, function (err, result) {
                if (err) throw err;
            });
        }
    }
...
alt.onClient('SCHUHE1', (player) => {
    ...
    verbindung.connection.query(`SELECT * FROM playerclohtes WHERE name = '${player.name}'`, function (err, result) {
        if (err) throw err;
        if (result.length > 0) {
              verbindung.connection.query(`UPDATE playerclohtes SET shoes_style = '${value}' WHERE name = '${player.name}'`, function (err, result) {
                if (err) throw err;
            });
        } else {
                verbindung.connection.query(`INSERT INTO playerclohtes (name, shoes_style) VALUES ('${player.name}', '${value}')`, function (err, result) {
                if (err) throw err;
            });
        }
    }
...
alt.onClient('FRISUR1', (player) => {
    ...
    verbindung.connection.query(`SELECT * FROM playerclohtes WHERE name = '${player.name}'`, function (err, result) {
        if (err) throw err;
        if (result.length > 0) {
              verbindung.connection.query(`UPDATE playerclohtes SET hair_style = '${style}' WHERE name = '${player.name}'`, function (err, result) {
                if (err) throw err;
                });
                verbindung.connection.query(`UPDATE playerclohtes SET hair_texture = '${color}' WHERE name = '${player.name}'`, function (err, result) {
                    if (err) throw err;
                    });
        } else {
                verbindung.connection.query(`INSERT INTO playerclohtes (name, hair_style, hair_texture) VALUES ('${player.name}', '${value}')`, function (err, result) {
                if (err) throw err;
            });
        }
    }
